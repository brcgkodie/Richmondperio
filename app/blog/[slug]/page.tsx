...
> = {
  "what-to-expect-dental-implant-consultation": {
    ...
    authorSlug: "kara-dunegan-gilliam",
    content: [
  ...
  "gum-grafting-recovery-tips": {
    ...
    author: "Dr. Ashley California, DDS, MS",
    authorSlug: "ashley-california",
    content: [
      ...
      "At Richmond Periodontics, we provide detailed written and verbal aftercare instructions tailored to your specific procedure. If you have any questions or concerns during your recovery, our team is always just a phone call away.",
    ],
  },
};
...
export default async function BlogPostPage({
  ...
  const breadcrumbs = [
    ...
    { name: "Blog", url: "https://richmondperio.com/blog" },
    { name: post.title, url: `https://richmondperio.com/blog/${slug}` },
  ];
