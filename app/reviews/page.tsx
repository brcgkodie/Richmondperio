          ...
          <div className="mx-auto max-w-7xl px-6">
            ...
            <div className="mt-12 text-center">
              <a
                ...
                className="inline-flex items-center gap-2 rounded-full border border-neutral-300 px-8 py-4 text-sm font-semibold text-neutral-700 transition-colors hover:bg-neutral-50"
              >
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  viewBox="0 0 24 24"
