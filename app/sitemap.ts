...
import { SERVICES, TEAM, SITE_URL } from "@/lib/constants";
...
export default function sitemap(): MetadataRoute.Sitemap {
  const staticPages: MetadataRoute.Sitemap = [
    ...
    { url: `${BASE_URL}/patient-resources/pre-operative-instructions`, lastModified: new Date(), changeFrequency: "monthly", priority: 0.5 },
    { url: `${BASE_URL}/patient-resources/pre-operative-oral-sedation`, lastModified: new Date(), changeFrequency: "monthly", priority: 0.5 },
    { url: `${BASE_URL}/patient-resources/pre-operative-iv-sedation`, lastModified: new Date(), changeFrequency: "monthly", priority: 0.5 },
    { url: `${BASE_URL}/patient-resources/post-operative-instructions`, lastModified: new Date(), changeFrequency: "monthly", priority: 0.5 },
    { url: `${BASE_URL}/patient-resources/sinus-surgery-post-op`, lastModified: new Date(), changeFrequency: "monthly", priority: 0.5 },
